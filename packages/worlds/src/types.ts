...
import type { WorldsStorageManager } from "#/storage.ts";
import type { ApiKeysRepository } from "#/system/keys/repository.ts";
import type { NamespacesRepository } from "#/system/namespaces/repository.ts";
import type { WorldsRepository } from "#/system/worlds/repository.ts";
import type {
  World,
  WorldsCreateInput,
  WorldsDeleteInput,
...
export interface WorldsContext {
  ...
  /**
   * keys is the repository for API keys.
   */
  keys: ApiKeysRepository;

  /**
   * namespaces is the repository for namespaces.
   */
  namespaces: NamespacesRepository;

  /**
   * worlds is the repository for world metadata.
   */
  worlds: WorldsRepository;

  /**
   * storage is the world storage manager for per-world data.
   */

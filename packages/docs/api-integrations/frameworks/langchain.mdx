...
title: "LangChain"
description:
  "Integrate Worlds as a persistent VectorStore and Memory for LangChain."
---

# LangChain Integration

LangChain provides a standard interface for memory and vector search. Worlds can
be integrated as a custom `VectorStore` or a `BaseChatMessageHistory`.
...
- Check out the [Social Graphs](/cookbook/social-graphs) guide for specialized
  knowledge structures.
- Learn about [Connectors](/developer-platform/concepts/connectors) to
  automatically sync external data into LangChain.

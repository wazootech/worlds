...
A **triple**, also called a _triplet_, is the smallest piece of information
stored in a World. Every fact is expressed as three components:

| Component     | Role                         | Example          |
| :------------ | :--------------------------- | :--------------- |
| **Subject**   | The entity being described   | `user:ethan`     |
| **Predicate** | The relationship or property | `schema:worksAt` |
| **Object**    | The target value or entity   | `org:wazoo`      |

---
title: "SPARQL"
description: "Querying your world with SPARQL 1.1"
---

**SPARQL** (SPARQL Protocol and RDF Query Language) is the standard query language for graph data. Worlds API supports the full [SPARQL 1.1 Client](https://www.w3.org/TR/sparql11-overview/) specification.

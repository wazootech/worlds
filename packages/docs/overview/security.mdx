...
description: "Managing API keys, authentication, and security boundaries."
---

Worlds provides an authentication layer and strict tenant isolation to
...
### 1. API Keys for agents and SDKs
...
### 2. Identity Service for humans and the Console

...
for edge-distributed, agentic memory. Built on the [Deno](https://deno.com/)
runtime, it separates the **Worlds Console** for management from the
**Worlds API** for high-performance execution.
...
hybrid search. This is the API layer where your information lives.
...
[Request flow](/reference/request-flow) reference.

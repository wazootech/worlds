...
- [Philosophy](/overview/introduction) â€” principles behind the approach
...
ambiguous language into structured **[triples](/worlds/facts)** (subject â†’
...
Worlds storage engine, refer to the
[Whitepaper](/overview/introduction#whitepaper).

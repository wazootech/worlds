...
Semantic Web succeeded by going invisible—becoming the underlying infrastructure
...
- **Transclusion replaces copy-pasting**: A statement, which is an atom of
  ...
  duplicating it—realizing the vision of connected knowledge at a planetary
  scale.

---
title: "Features"
description: "Core capabilities including neuro-symbolic memory and semantic search."
---
...
The Worlds engine uses LLMs to extract meaning and entities. It translates ambiguous language into structured **triples** (subject → predicate → object). These facts then merge into a **world**—an isolated container where the graph evolves through:
...
For a deeper dive into the mathematical and philosophical foundations of the Worlds storage engine, refer to the [Whitepaper](/overview/whitepaper).

...
- **Analytical scale**: Continuous AI workflows like GraphRAG require
  fast, multi-hop lookups. Relational DB joins degrade rapidly at scale.structure to traverse complex
  relationships quickly under pressure.

...
or `givenName`. The set of valid properties forms the ontology. Agents use the
[Core Ontology](/worlds/ontology) to interact with the graph.
...
allowing agents to understand exactly how state and information evolve. See the
[Core Ontology](/worlds/ontology) for the standard `worlds:Fact` definition.

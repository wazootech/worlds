...
or `givenName`. The set of valid properties forms the ontology. Agents use the [Core Ontology](/contribute/architecture#semantic-data-model) to interact with the graph.
...
allowing agents to understand exactly how state and information evolve. See the [Core Ontology](/contribute/architecture#semantic-data-model) for the standard `worlds:Fact` definition.

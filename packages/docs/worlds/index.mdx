...
```turtle N-Triples
<http://user.example/ethan> <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <https://schema.org/Person> .
```
...
```turtle N-Triples
<http://user.example/ethan> <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <https://schema.org/Person> .
<http://user.example/ethan> <https://schema.org/givenName> "Ethan" .
```
...
ASK WHERE {
  <http://user.example/ethan> org:worksAt <http://org.example/wazoo> .
}
```

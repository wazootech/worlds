...
A **World** is the foundational resource of the Worlds Platform. It is an isolated container for your agents to store and query context. Every world
has its own dedicated libSQL database, embeddings collection, and caching layer.

...
A world mutates its state using RDF patches—granular additions and deletions of
facts. Because Worlds functions as a chronological, append-only ledger, these
patches permanently preserve historical truth.

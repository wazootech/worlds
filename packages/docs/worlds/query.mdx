...
traverse its connected facts using **SPARQL** (SPARQL Protocol and RDF 
Query Language). This is the W3C standard for knowledge graphs.
...
agency**. Learn more about the theory in the [Architecture](/contribute/architecture#alignment--intentional-agency) deep-dive.

...
description: "Manage your worlds from the command line using the Worlds CLI."
---

The Worlds CLI allows you to manage worlds, import data, and execute queries
...
Now that you have set up your first world, explore the full capabilities of the
CLI:

- [View source on GitHub](https://github.com/wazootech/worlds/tree/main/packages/cli)
- [Search and SPARQL](/guides/semantic-search)

...
Once the Console is running, it will automatically manage local Worlds API
processes.
...
<Steps>
  ...
  <Step title="Configuration">
    The Worlds API Server will automatically attempt to connect to the local Ollama instance at `http://127.0.0.1:11434`. Override this in your environment:

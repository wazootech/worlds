...
collapsing to just 20% on complex, multi-hop queries. In contrast, systems
utilizing a deterministic context graph consistently achieve 90–99% accuracy.
The reasoning gap occurs because disparate vector search exacerbates two

...
> = {
  name: "worlds_update",
  description:
    "Updates an existing world's metadata, such as its label or description. Input must include the 'slug' and at least one field to change. Returns a success indicator.",
